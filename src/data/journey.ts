...
export const journeyMilestones: JourneyMilestone[] = [
  ...
  },
  {
    ...
    description:
      "Identified real administrative friction in college classrooms and built SmartAttend — a role-based attendance management platform with JWT authentication and PostgreSQL backend.",
    takeaways: [
