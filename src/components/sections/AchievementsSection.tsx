  ...
  return (
    <section id="achievements" className="py-20 lg:py-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          badgeText="Achievements &amp; Certifications"
          title="Hackathons, Honors &amp; Credentials"
          subtitle="Milestones earned through competitive hackathons, industry certifications, and technical symposiums."
        />
              ...
              {item.link && (
                <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-brand-600 dark:text-brand-400 hover:text-brand-500 transition-colors"
                  >
